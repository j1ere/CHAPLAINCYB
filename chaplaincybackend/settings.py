"""
Django settings for chaplaincybackend project.
...
SECRET_KEY = 'django-insecure-9t=(=t)*z64!tbh_88mn*ljt1f-$c1#!du7m#@u0@wulwweecc'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ["localhost", "127.0.0.1", "stanneschaplaincy.com"]
...
EMAIL_HOST_PASSWORD = 'QKeCjaNcVBkk'   # ← Use App-specific password (see below)
